...
const FlexDue = () => {
 ...
 // Toggle for showing history
  ...
  const handleApproveExtension = async (taskId) => {
    ...
    try {
      const response = await axios.put(
        `https://taskflow-enlep7oc.b4a.run/api/tasks/${taskId}/extension/approve`,
        {
          approvedDueDate,
        }
      );
  ...
  const handleDeclineExtension = async (taskId) => {
    ...
    try {
      const response = await axios.put(
        `https://taskflow-enlep7oc.b4a.run/api/tasks/${taskId}/extension/decline`,
        {
  ...
  const handleApproveCancellation = async (taskId) => {
    ...
    try {
      const response = await axios.put(
        `https://taskflow-enlep7oc.b4a.run/api/tasks/${taskId}/cancellation/approve`,
        {}
      );
  ...
  const handleDeclineCancellation = async (taskId) => {
    ...
    try {
      const response = await axios.put(
        `https://taskflow-enlep7oc.b4a.run/api/tasks/${taskId}/cancellation/decline`,
        {
          feedback: feedbackForDecline,
        }
      );
  ...
  const openFileInNewTab = (filename) => {
    window.open(`https://taskflow-enlep7oc.b4a.run/api/tasks/view/${filename}`, "_blank");
  };
