...
const AdminDashboard = () => {
  ...
  const handleViewUser = (userId) => {
    // Here you would typically navigate to a user detail page
    // For now, we'll just set the selected user
    setSelectedUser(usersMap[userId]);
    // You could also open a modal or navigate to a user detail page
    alert(`Viewing details for user: ${usersMap[userId]?.username}`);
  };
