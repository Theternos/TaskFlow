                ...
                <div className="task-modal-sidebar-section file-attachment">
                  ...
                  <div className="section-content file-actions">
                    ...
                    <button 
                      ...
                      onClick={() => window.open(`https://taskflow-enlep7oc.b4a.run/api/tasks/view/${task.file.filename}`, '_blank')}
                      disabled={isLoading}
                    >
                            ...
                            <div className="submission-detail-item">
                              ...
                              <div className="submission-file-actions">
                                ...
                                <button 
                                  ...
                                  onClick={() => window.open(`https://taskflow-enlep7oc.b4a.run/api/tasks/view/${submission.file.filename}`, '_blank')}
                                >
                                  View &nbsp;
                                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
